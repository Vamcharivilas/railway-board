...
//import com.sid.Railway.App;
//import com.sid.Railway.TicketClient;
//import com.sid.Railway.TrainClient;
...
public class MainOperation {
	...
	private static void TrainManagement() {
		...
		switch (choice) {
		case 1:
			TrainClient.main(null); // Launch Ticket Management
			break;
		case 2:
			return;
		default:
	...
	private static void TicketManagement() {
		...
		switch (choice) {
		case 1:
			TicketClient.main(null); // Launch Ticket Management
			break;
		case 2:
			return;
		default:
